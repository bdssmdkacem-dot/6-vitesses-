  ...
  @override Widget build(BuildContext context){
    ...
    final hudLayer=Stack(fit:StackFit.expand,children:[
      ...
      SafeArea(child:Stack(children:[
        ...
        Positioned(right:120,top:46,child:GearIndicator(gear:displayGear,theme:_theme,enabled:true)),
        ...
        if (gtEnabled && gtSpec.showMap && navigationActive)
          Positioned(
            left: widget.settings.gtLayout == GtLayout.nav ? 12 : null,
            right: widget.settings.gtLayout == GtLayout.touring ? 12 : null,
            top: widget.settings.gtLayout == GtLayout.nav ? 58 : null,
            bottom: widget.settings.gtLayout == GtLayout.touring ? 108 : null,
            child: GtRouteMap(
